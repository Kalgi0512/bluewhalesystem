      ...
      case 'profile':
        return (
          <div className="space-y-6">
            ...
            <div>
              <h3 className="text-description-lg font-semibold text-gray-800 mb-4">Security</h3>
              {!showPasswordForm ? (
                ...
                <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                  <h4 className="font-medium text-gray-800 mb-3">Update Password</h4>
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full p-3 border border-gray-300 rounded-xl focus:border-[var(--color-primary)] focus:ring-2 focus:ring-blue-200 focus:outline-none transition-all duration-200 pr-10"
                        />
                        <button 
                    ...
                    <div className="flex gap-2 mt-4">
                      <button 
                        ...
                        className="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-100 transition-colors text-sm"
                      >
                        Cancel
                      </button>
                      <button 
                        ...
                        className="px-4 py-2 bg-[var(--color-primary)] text-white rounded-lg font-medium hover:opacity-90 transition-colors text-sm"
                      >
                        Update Password
                      </button>
                    </div>
        ...
        return (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-gray-600 mb-6">Choose how you want to be notified about different activities in the system.</p>
              
              <div className="space-y-4">
                {[
                  { key: 'candidateUpdates', label: 'Candidate Updates', description: 'Get notified when candidates update their profiles or applications', icon: <User size={18} className="text-green-500" /> },
                  { key: 'documentUpdates', label: 'Document Updates', description: 'Receive alerts when new documents are uploaded or require review', icon: <FileText size={18} className="text-blue-500" /> },
                  { key: 'statusChanges', label: 'Visa/Application Status Changes', description: 'Notify me about changes to application or visa statuses', icon: <Shield size={18} className="text-amber-500" /> },
                  { key: 'meetingReminders', label: 'Meeting Reminders', description: 'Send reminders for scheduled meetings and interviews', icon: <Calendar size={18} className="text-purple-500" /> },
                ].map((item) => (
            ...
            <div>
              <h3 className="text-description-lg font-semibold text-gray-800 mb-4">Notification Channels</h3>
              <div className="space-y-4">
                {[
                  { key: 'emailNotifications', label: 'Email Notifications', icon: <Mail size={20} className="text-cyan-500" /> },
                  { key: 'inAppNotifications', label: 'In-App Notifications', icon: <Smartphone size={20} className="text-indigo-500" /> },
                ].map((item) => (
                  <div key={item.key} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
                    <div className="flex items-center gap-3">
                      {item.icon}
      ...
      <div className="relative z-10">
        ...
        >
          <div className="space-y-2">
            <motion.h1
              className="text-heading-lg font-bold bg-gradient-primary bg-clip-text pb-1 text-transparent"
            >
              Settings
            </motion.h1>
